...
import { Form, FormControl, FormLabel, Input, Textarea, Table, Tbody, Tr, Th, Td, Button, Box, Heading } from '@chakra-ui/react';
  ...
  return (
    <Box bg="gray.100" p={4} borderRadius="md">
      <Heading as="h3" size="md">
        Grade Student Submissions for Project: {projectId}
      </Heading>
